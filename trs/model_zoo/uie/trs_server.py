...
from trs_router import HttpRouterManager
from paddlenlp.server.model_manager import ModelManager
from paddlenlp.server.taskflow_manager import TaskflowManager
from paddlenlp.taskflow import Taskflow


class TrsSimpleServer(FastAPI):
